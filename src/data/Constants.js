...
export const about = {
  ...
  overall: {
    title: "این امپراتوی ماست، امپراتوری کد ها و کدزن ها",
    describe:
      "همین الان میتونی فرم تماس با ما رو پر کنی تا در نخستین زمان ممکن باهات تماس بگیریم و ماجراجویی رو شروع کنیم!",
    links: [
      {
...
export const coursesOverall = {
  title: "اگه نمیدونی کدومو میخوای کارشناسای ما میتونن کمکت کنن",
  describe: "میتونی یا زنگ بزنی یا فرم تماس پر کنی ما زنگ بزنیم :)",
  links: [
    {
      link: "mailto:duckdukstay@hotmail.com",
      label: "ارسال ایمیل",
...
export const contactInfo = [
  ...
  {
    label: "آدرس دفتر",
    describe: "تهران، دروس، خیابان پاسداران، برج سفید، طبقه 5",
  },
];
